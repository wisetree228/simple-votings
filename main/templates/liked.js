...
const mockLikedPosts = [
    ...
    },
    {
        ...
        options: [
            { text: 'Tailwind CSS', votes: 88 },
            { text: 'Bootstrap', votes: 65 },
            { text: 'Material UI', votes: 45 },
            { text: 'Bulma', votes: 22 }
        ],
        likes: 55,
        dislikes: 3,
        comments: [
            {
                id: 1,
                author: 'Mike Brown',
                content: 'Tailwind CSS is amazing for rapid development!',
        ...
        <div class="post-actions">
            ...
            <button class="action-btn">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0 <boltAction type="file" filePath="liked.js">-1.79 1.11L12 22h0a3.13 3.13 0 0 1-3-3.88Z"></path>
                </svg>
                ${post.dislikes}
            </button>
